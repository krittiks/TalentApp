...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            ...
            var link = param != "" ? 'https://webapptalent.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                 : 'https://webapptalent.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
       ...
       // console.log("date:", jobData.jobDetails.startDate);
        ...
        $.ajax({
            ...
            url : 'https://webapptalent.azurewebsites.net/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
